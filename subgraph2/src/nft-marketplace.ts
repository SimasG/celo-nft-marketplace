// ** `graph codegen` generates all files in the `generated` folder. It converts our contract
// ** events and GraphQL entity definitions into Typescript types, so we can use them for
// ** type-safe programming in our script
import {
  ListingCanceled,
  ListingCreated,
  ListingPurchased,
...
export function handleListingCreated(event: ListingCreated): void {
  ...
  // ** How did `graph codegen` know that I'd like `ListingEntity` to take 1 argument?
