...
const Create = () => {
  ...
  async function handleCreateListing() {
    ...
    try {
      // Make sure the contract address is a valid address (`isAddress` is an ethers func)
  ...
  async function requestApproval() {
    ...
    const isApproved: boolean = await ERC721Contract.isApprovedForAll(
      address,
      MARKETPLACE_ADDRESS
    );
  ...
  // "Give permission to access all of your CeloNFT? By granting permission,
  // you are allowing the following contract to access your funds"
  // We have to give `NFTMarketplace` our approval to transfer the NFT(s) we own
  // on our behalf to the buyer (in exchange for receiving CELO tokens, of course).
  // ** I wonder why do I have to give access to ALL of my NFTs from CeloNFT collection tho, not just 1?
  // ** Also, why do I have to allow my `NFTMarketplace` contract to access
  // ** my account funds just to create a listing?
    ...
    <>
      ...
      <div className="containerCreate">
        ...
        <input
          ...
          onChange={(e) => {
            if (e.target.value === "") {
              // ** It shouldn't even be possible to have an NFT price of 0, no?
              setPrice("0");
            } else {
